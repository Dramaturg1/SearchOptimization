...
class BeesMethod:
    def __init__(self, view, current_func, current_zmin, current_zmax, window):
        ...
        self.n_scouts = 16
        self.n_elite_sites = 2
        self.n_perspective_sites = 3
        self.n_elite_bees = 7
        self.n_perspective_bees = 4
        self.radius = 0.2
        self.stagnation_limit = 200
    ...
    def show_point(self, x, y):
        ...
        self.temp_point_item = gl.GLScatterPlotItem(pos=pos, size=3, color=(1, 0, 0, 1))
    ...
    def run(self, max_iter=500, n_scouts=16):
        ...
        for iteration in range(max_iter):
            ...
            best_idx = np.argmax(self.scout_values)
            best_x, best_y = self.scouts[best_idx]
            current_best_pos = [best_x, best_y]
