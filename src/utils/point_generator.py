...
class PointGenerator:
    """Генератор случайных точек в пределах заданной области"""
    ...
    def generate_grid(self, nx=5, ny=5):
        """Генерация точек на равномерной сетке"""
